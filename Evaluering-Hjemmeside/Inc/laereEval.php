...
if($result->num_rows > 0) {
	...
	echo "<table id='search' class='table'  bordered='1'>
		...
		while($row = $result->fetch_assoc()) {
			...
			<td>". "<button class='but2' name='uge4' type='submit'> Evaluer". "</button></td>
			<td>". "<button class='but2' name='uge7' type='submit'> Evaluer". "</button></td>     		
...
function ChangeText(Elev){
	...
	document.getElementById("ElevNavn").innerHTML = Elev;
